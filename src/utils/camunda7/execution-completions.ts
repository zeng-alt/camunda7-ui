...
function tooltipHtml(prefix: string, label: string, typeLabel: string | null, info: string): string {
  const dark = isDark()
...
const executionCtx: ContextDef = {
  ...
  methods: [
    { label: 'getVariable', detail: '(variableName: string) => Object', info: '获取指定名称的流程变量（含父作用域）', apply: 'getVariable("")' },
    { label: 'setVariable', detail: '(variableName: string, value: any) => void', info: '设置流程变量', apply: 'setVariable("", )' },
    { label: 'hasVariable', detail: '(variableName: string) => boolean', info: '检查指定名称的流程变量是否存在', apply: 'hasVariable("")' },
    { label: 'removeVariable', detail: '(variableName: string) => void', info: '删除指定名称的流程变量', apply: 'removeVariable("")' },
    { label: 'getVariableLocal', detail: '(variableName: string) => Object', info: '获取本地作用域的流程变量', apply: 'getVariableLocal("")' },
    { label: 'setVariableLocal', detail: '(variableName: string, value: any) => void', info: '设置本地作用域的流程变量', apply: 'setVariableLocal("", )' },
    { label: 'hasVariableLocal', detail: '(variableName: string) => boolean', info: '检查本地作用域的流程变量是否存在', apply: 'hasVariableLocal("")' },
    { label: 'removeVariableLocal', detail: '(variableName: string) => void', info: '删除本地作用域的流程变量', apply: 'removeVariableLocal("")' },
    { label: 'getVariableTyped', detail: '(variableName: string) => TypedValue', info: '获取带类型信息的流程变量', apply: 'getVariableTyped("")' },
    { label: 'setVariableTyped', detail: '(variableName: string, value: TypedValue) => void', info: '设置带类型信息的流程变量', apply: 'setVariableTyped("", )' },
    { label: 'getVariableLocalTyped', detail: '(variableName: string) => TypedValue', info: '获取本地带类型信息的流程变量', apply: 'getVariableLocalTyped("")' },
    { label: 'setVariableLocalTyped', detail: '(variableName: string, value: TypedValue) => void', info: '设置本地带类型信息的流程变量', apply: 'setVariableLocalTyped("", )' },
    { label: 'getVariables', detail: '() => { [key: string]: any }', info: '获取所有流程变量', apply: 'getVariables()' },
    { label: 'getVariablesLocal', detail: '() => { [key: string]: any }', info: '获取所有本地流程变量', apply: 'getVariablesLocal()' },
    { label: 'getVariablesTyped', detail: '() => { [key: string]: TypedValue }', info: '获取所有带类型信息的流程变量', apply: 'getVariablesTyped()' },
    { label: 'getVariablesLocalTyped', detail: '() => { [key: string]: TypedValue }', info: '获取所有本地带类型信息的流程变量', apply: 'getVariablesLocalTyped()' },
    { label: 'setVariables', detail: '(variables: { [key: string]: any }) => void', info: '批量设置流程变量', apply: 'setVariables({})' },
    { label: 'setVariablesLocal', detail: '(variables: { [key: string]: any }) => void', info: '批量设置本地流程变量', apply: 'setVariablesLocal({})' },
    { label: 'getProcessInstanceId', detail: '() => string', info: '获取流程实例 ID', apply: 'getProcessInstanceId()' },
    { label: 'getProcessBusinessKey', detail: '() => string', info: '获取流程实例的 Business Key', apply: 'getProcessBusinessKey()' },
    { label: 'getProcessDefinitionId', detail: '() => string', info: '获取流程定义 ID', apply: 'getProcessDefinitionId()' },
    { label: 'getCurrentActivityId', detail: '() => string', info: '获取当前活动节点 ID', apply: 'getCurrentActivityId()' },
    { label: 'getCurrentActivityName', detail: '() => string', info: '获取当前活动节点名称', apply: 'getCurrentActivityName()' },
    { label: 'getActivityInstanceId', detail: '() => string', info: '获取当前活动实例 ID', apply: 'getActivityInstanceId()' },
    { label: 'getParentId', detail: '() => string', info: '获取父执行实例 ID', apply: 'getParentId()' },
    { label: 'getParentActivityInstanceId', detail: '() => string', info: '获取父活动实例 ID', apply: 'getParentActivityInstanceId()' },
    { label: 'getId', detail: '() => string', info: '获取当前执行实例 ID', apply: 'getId()' },
    { label: 'getEventName', detail: '() => string', info: '获取当前触发的事件名称', apply: 'getEventName()' },
    { label: 'getBusinessKey', detail: '() => string', info: '获取当前执行实例的 Business Key', apply: 'getBusinessKey()' },
    { label: 'getTenantId', detail: '() => string', info: '获取租户 ID', apply: 'getTenantId()' },
    { label: 'getCurrentTransitionId', detail: '() => string', info: '获取当前迁移 ID', apply: 'getCurrentTransitionId()' },
  ],
  properties: [
...
const taskCtx: ContextDef = {
  ...
  methods: [
    { label: 'getAssignee', detail: '() => string', info: '获取任务处理人', apply: 'getAssignee()' },
    { label: 'setAssignee', detail: '(userId: string) => void', info: '设置任务处理人', apply: 'setAssignee("")' },
    { label: 'getOwner', detail: '() => string', info: '获取任务所有者', apply: 'getOwner()' },
    { label: 'setOwner', detail: '(userId: string) => void', info: '设置任务所有者', apply: 'setOwner("")' },
    { label: 'addCandidateUser', detail: '(userId: string) => void', info: '添加候选人', apply: 'addCandidateUser("")' },
    { label: 'addCandidateGroup', detail: '(groupId: string) => void', info: '添加候选组', apply: 'addCandidateGroup("")' },
    { label: 'addCandidateUsers', detail: '(userIds: string[]) => void', info: '批量添加候选人', apply: 'addCandidateUsers([])' },
    { label: 'addCandidateGroups', detail: '(groupIds: string[]) => void', info: '批量添加候选组', apply: 'addCandidateGroups([])' },
    { label: 'deleteCandidateUser', detail: '(userId: string) => void', info: '移除候选人', apply: 'deleteCandidateUser("")' },
    { label: 'deleteCandidateGroup', detail: '(groupId: string) => void', info: '移除候选组', apply: 'deleteCandidateGroup("")' },
    { label: 'setPriority', detail: '(priority: number) => void', info: '设置任务优先级', apply: 'setPriority()' },
    { label: 'getPriority', detail: '() => number', info: '获取任务优先级', apply: 'getPriority()' },
    { label: 'setDueDate', detail: '(date: Date) => void', info: '设置任务到期时间', apply: 'setDueDate()' },
    { label: 'getDueDate', detail: '() => Date', info: '获取任务到期时间', apply: 'getDueDate()' },
    { label: 'setFollowUpDate', detail: '(date: Date) => void', info: '设置任务跟进时间', apply: 'setFollowUpDate()' },
    { label: 'getFollowUpDate', detail: '() => Date', info: '获取任务跟进时间', apply: 'getFollowUpDate()' },
    { label: 'addComment', detail: '(comment: string) => void', info: '添加任务评论', apply: 'addComment("")' },
    { label: 'getComments', detail: '() => Comment[]', info: '获取所有任务评论', apply: 'getComments()' },
    { label: 'deleteComment', detail: '(commentId: string) => void', info: '删除任务评论', apply: 'deleteComment("")' },
    { label: 'complete', detail: '() => void', info: '完成当前任务', apply: 'complete()' },
    { label: 'save', detail: '() => void', info: '保存任务变更', apply: 'save()' },
    { label: 'getTaskLocalVariables', detail: '() => { [key: string]: any }', info: '获取任务本地变量', apply: 'getTaskLocalVariables()' },
    { label: 'setTaskLocalVariables', detail: '(vars: { [key: string]: any }) => void', info: '设置任务本地变量', apply: 'setTaskLocalVariables({})' },
    { label: 'getExecutionId', detail: '() => string', info: '获取关联的执行实例 ID', apply: 'getExecutionId()' },
  ],
  properties: [
...
const variablesCtx: ContextDef = {
  ...
  methods: [
    { label: 'get', detail: '(variableName: string) => Object', info: '获取流程变量值', apply: 'get("")' },
    { label: 'getTyped', detail: '(variableName: string) => TypedValue', info: '获取带类型信息的流程变量', apply: 'getTyped("")' },
    { label: 'set', detail: '(variableName: string, value: any) => void', info: '设置流程变量', apply: 'set("", )' },
    { label: 'setTyped', detail: '(variableName: string, value: TypedValue) => void', info: '设置带类型的流程变量', apply: 'setTyped("", )' },
    { label: 'remove', detail: '(variableName: string) => void', info: '删除流程变量', apply: 'remove("")' },
    { label: 'has', detail: '(variableName: string) => boolean', info: '检查流程变量是否存在', apply: 'has("")' },
    { label: 'getAll', detail: '() => { [key: string]: any }', info: '获取所有流程变量', apply: 'getAll()' },
    { label: 'removeAll', detail: '() => void', info: '删除所有流程变量', apply: 'removeAll()' },
    { label: 'containsKey', detail: '(key: string) => boolean', info: '检查变量名是否存在', apply: 'containsKey("")' },
...
const inputParameterCtx: ContextDef = {
  ...
  methods: [
    ...
    { label: 'put', detail: '(key: string, value: any) => Object', info: '设置输入参数', apply: 'put("", )' },
    { label: 'remove', detail: '(key: string) => Object', info: '移除输入参数', apply: 'remove("")' },
    { label: 'containsKey', detail: '(key: string) => boolean', info: '检查 Key 是否存在', apply: 'containsKey("")' },
    { label: 'containsValue', detail: '(value: any) => boolean', info: '检查 Value 是否存在', apply: 'containsValue()' },
    ...
    { label: 'putAll', detail: '(map: { [key: string]: any }) => void', info: '批量添加输入参数', apply: 'putAll({})' },
  ],
  properties: [],
}
...
const outputParameterCtx: ContextDef = {
  ...
  methods: [
    ...
    { label: 'put', detail: '(key: string, value: any) => Object', info: '设置输出参数', apply: 'put("", )' },
    { label: 'remove', detail: '(key: string) => Object', info: '移除输出参数', apply: 'remove("")' },
    { label: 'containsKey', detail: '(key: string) => boolean', info: '检查 Key 是否存在', apply: 'containsKey("")' },
    { label: 'containsValue', detail: '(value: any) => boolean', info: '检查 Value 是否存在', apply: 'containsValue()' },
    { label: 'keySet', detail: '() => string[]', info: '获取所有参数名集合', apply: 'keySet()' },
    { label: 'values', detail: '() => any[]', info: '获取所有参数值集合', apply: 'values()' },
    ...
    { label: 'putAll', detail: '(map: { [key: string]: any }) => void', info: '批量添加输出参数', apply: 'putAll({})' },
  ],
  properties: [],
}
...
export const contextKeywordCompletionSource = (context: CompletionContext): CompletionResult | null => {
