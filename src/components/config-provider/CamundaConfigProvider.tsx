...
export default defineComponent({
  ...
  setup(props, { slots }) {
    ...
    const mergedTimeFormat = computed(() => props.timeFormat ?? parentConfig?.timeFormatRef.value ?? "YYYY-MM-DD HH:mm:ss");
    const mergedThemeOverrides = computed(() => props.themeOverrides ?? parentConfig?.themeOverridesRef.value);
